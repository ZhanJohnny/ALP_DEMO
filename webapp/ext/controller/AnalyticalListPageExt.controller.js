sap.ui.controller("IBSO.ALP_DEMO.ext.controller.AnalyticalListPageExt", {
	...
	onBeforeRebindFilterableKPIExtension: function (oSelectionVariant, sEntityType, sKPIId) {
		if (sKPIId ===
			"IBSO.ALP_DEMO::sap.suite.ui.generic.template.AnalyticalListPage.view.AnalyticalListPage::SEPMRA_C_PD_ProductSalesData--template::KPITag::kpi::KPIRevenue1"
		) {
